    ...
    <div class="container-body">
        ...
        <div class="card detail-body">
            ...
            <div class="detail-directory">
                ...
                <div class="directory-title">{{ $list->texteditor_title }}</div>
                @if (!is_null($list->texteditor_topic_picture))
                    <div class="directory-img-topic">
                        <img src="{{ asset('storage/' . $list->texteditor_topic_picture) }}" alt="" width="400"
                            class="img-directory-topic">
                    </div>
                @endif
                <div class="directory-text-box mt-6">
