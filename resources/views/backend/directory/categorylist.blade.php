                ...
                <caption>
                    <div class="row">
                        ...
                        <div class="col-md-auto ms-auto">
                            <a href="{{ route('directory.category.add', ['menu' => $menuId]) }}""><button type="button"
                            ...
                            <a href="{{ route('directory.category', ['menu' => $menuId, 'cate' => 0]) }}"
                        ...
                        @else
                            @foreach ($list as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a
                                            href="{{ route('directory.category.edit', ['menu' => $menuId, 'id' => $item->categories_id]) }}">
    ...
    <script>
        function deleteItem(url) {
            Swal.fire({
                ...
                text: "เมื่อกดยืนยัน หมวดหมู่ที่ท่านเลือกและข้อมูลที่อยู่ในหมวดหมู่ที่ท่านเลือกจะไม่แสดงอีกต่อไป",
                icon: 'warning',
