                ...
                @if ($cateID !== '0')
                    <thead>
                        <tr>
                            ...
                            <th scope="col"class="col-2 text-center align-middle" style="width: 55%;">หัวข้อ</th>
                        ...
                        @else
                            @foreach ($list as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a
                                            href="{{ route('directory.edit.datacat', ['menu' => $menuId, 'id' => $item->texteditor_id, 'cate' => $cateID]) }}">
                                        ...
                                        <a
                                            href="{{ route('directory.delete', ['menu' => $menuId, 'id' => $item->texteditor_id]) }}">
