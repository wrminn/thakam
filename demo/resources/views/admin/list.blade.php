                ...
                <tbody>
                    @foreach ($list as $item)
                        <tr>
                            ...
                            <th scope="row">{{ $item->id_new }}</th>
                            <td>{{ Str::limit($item->texteditor_title, 30) }}</td>
                            <td>{{ $item->texteditor_date_show }}</td>
                            <td>
                                <a href="/backend/edit/menu/{{ $menuId }}/id/{{ $item->texteditor_id }}"><button
                                ...
                                <a href="/backend/delete/menu/{{ $menuId }}/id/{{ $item->texteditor_id }}">
