    ...
    <div class="container">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="" action="{{ route('texteditor.update', ['menu' => $menuId,'id' => $id]) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col">
                            <div class="mb-3">
                                <label class="form-label">วันที่</label>
                                <input type="date" name="date" class="form-control" required value="{{ $list->texteditor_date_show }}">
                            </div>
                        </div>
                        <div class="col">
                            <div class="mb-3">
                                @if (!empty($list->texteditor_date_show))
                                    <img src="{{ $list->texteditor_topic_picture }}" alt="">
                                @endif
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="topic" required value="{{ $list->texteditor_id }}">
                    </div>
